...
<form method="post" action="admin-post.php">
		...
		<div id="tabs" class="azrcrv-ui-tabs">
			<ul class="azrcrv-ui-tabs-nav azrcrv-ui-widget-header" role="tablist">
				<li class="azrcrv-ui-state-default azrcrv-ui-state-active" aria-controls="tab-panel-results" aria-labelledby="tab-results" aria-selected="true" aria-expanded="true" role="tab">
					<?php // phpcs:ignore. ?>
					<a id="tab-results" class="azrcrv-ui-tabs-anchor" href="#tab-panel-results"><?php echo $tab_results_label; ?></a>
				</li>
			...
			<div id="tab-panel-results" class="azrcrv-ui-tabs-scroll" role="tabpanel" aria-hidden="false">
				<fieldset>
					<legend class='screen-reader-text'>
						<?php
						// phpcs:ignore.
						echo $tab_results_label;
						?>
					</legend>
					<?php
					// phpcs:ignore.
	...
	<input type="submit" name="btn_save" value="<?php esc_html_e( 'Save Settings', 'azrcrv-bl' ); ?>" class="button-primary"/>
</form>
<?php
/*
...
<div class='azrcrv-donate'>
	...
	<span>
		<?php
		esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-bl' );
		?>
	</span>
</div>
